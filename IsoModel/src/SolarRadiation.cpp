 ...
 * the inner surface loop with vector algebra identities (dot products).
 * 3. Flat Array Access: `eglobeFlat()` is now the primary high-performance accessor 
 * used by HourlyModel to avoid vector-of-vector copying.
 */
