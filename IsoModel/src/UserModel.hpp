...
public:
  ...
  /// Gets a Building property.
  [[nodiscard]] double buildingAirLeakage() const { return structure.infiltrationRate(); }

  /// Gets a Building property.
  [[nodiscard]] double buildingHeight() const { return structure.buildingHeight(); }

  /// Gets a Building property.
  [[nodiscard]] double buildingOccupancyFrom() const { return pop.daysStart(); }

  /// Gets a Building property.
  [[nodiscard]] double buildingOccupancyTo() const { return pop.daysEnd(); }

  /// Gets a Building property.
  [[nodiscard]] double constantIlluminationControl() const { return building.constantIllumination(); }

  /// Sets a Building property.
  void setConstantIlluminationControl(double val) { building.setConstantIllumination(val); }

  /// Gets a Building property.
  [[nodiscard]] double elecPowerAppliancesOccupied() const {
  ...
  /// Gets a Building property.
  [[nodiscard]] double elecPowerAppliancesUnoccupied() const {
  ...
  /// Gets a Building property.
  [[nodiscard]] double externalEquipment() const { return building.externalEquipment(); }
  ...
  /// Gets a Building property.
  [[nodiscard]] double gasAppliancePowerFixedOccupied() const {
  ...
  /// Gets a Building property.
  [[nodiscard]] double gasAppliancePowerFixedUnoccupied() const {
  ...
  /// Gets a Building property.
  [[nodiscard]] double gasPowerAppliancesOccupied() const { return building.gasApplianceHeatGainOccupied(); }

  /// Sets a Building property.
  void setGasPowerAppliancesOccupied(double val) { building.setGasApplianceHeatGainOccupied(val); }

  /// Gets a Building property.
  [[nodiscard]] double gasPowerAppliancesUnoccupied() const { return building.gasApplianceHeatGainUnoccupied(); }
  ...
  /// Gets a Building property.
  [[nodiscard]] double lightingOccupancySensorSystem() const { return building.lightingOccupancySensor(); }

  /// Sets a Building property.
  void setLightingOccupancySensorSystem(double val) { building.setLightingOccupancySensor(val); }

  /// Gets a Cooling property.
  [[nodiscard]] double coolingOccupiedSetpoint() const { return cooling.temperatureSetPointOccupied(); }
  ...
  /// Gets a Heating property.
  [[nodiscard]] double dhwEfficiency() const { return heating.hotWaterSystemEfficiency(); }

  /// Sets a Heating property.
  void setDhwEfficiency(double val) { heating.setHotWaterSystemEfficiency(val); }

  /// Gets a Heating property.
  [[nodiscard]] double dhwEnergyCarrier() const { return static_cast<double>(heating.hotWaterEnergyType()); }
  ...
  /// Gets a Heating property.
  [[nodiscard]] double dT_supp_ht() const { return heating.dT_supp_ht(); }

  /// Sets a Heating property.
  void setDT_supp_ht(double dT_supp_ht) { heating.setDT_supp_ht(dT_supp_ht); }

  /// Gets a Heating property.
  [[nodiscard]] double E_pumps_ht() const { return heating.E_pumps(); }

  /// Sets a Heating property.
  void setE_pumps_ht(double E_pumps) { heating.setE_pumps(E_pumps); }

  /// Gets a Heating property.
  [[nodiscard]] double eta_DH_network() const { return heating.eta_DH_network(); }

  /// Sets a Heating property.
  void setEta_DH_network(double eta_DH_network) { heating.setEta_DH_network(eta_DH_network); }

  /// Gets a Heating property.
  [[nodiscard]] double eta_DH_sys() const { return heating.eta_DH_sys(); }

  /// Sets a Heating property.
  void setEta_DH_sys(double eta_DH_sys) { heating.setEta_DH_sys(eta_DH_sys); }

  /// Gets a Heating property.
  [[nodiscard]] bool forcedAirHeating() const { return heating.forcedAirHeating(); }

  /// Sets a Heating property.
  void setForcedAirHeating(bool forcedAirHeating) { heating.setForcedAirHeating(forcedAirHeating); }

  /// Gets a Heating property.
  [[nodiscard]] double frac_DH_free() const { return heating.frac_DH_free(); }

  /// Sets a Heating property.
  void setFrac_DH_free(double frac_DH_free) { heating.setFrac_DH_free(frac_DH_free); }

  /// Gets a Heating property.
  [[nodiscard]] double heatingEnergyCarrier() const { return static_cast<double>(heating.energyType()); }
  ...
  /// Gets a Heating property.
  [[nodiscard]] double heatingOccupiedSetpoint() const { return heating.temperatureSetPointOccupied(); }
  ...
  /// Gets a Heating property.
  [[nodiscard]] double heatingSystemEfficiency() const { return heating.efficiency(); }

  /// Sets a Heating property.
  void setHeatingSystemEfficiency(double val) { heating.setEfficiency(val); }

  /// Gets a Heating property.
  [[nodiscard]] double heatingUnoccupiedSetpoint() const { return heating.temperatureSetPointUnoccupied(); }
  ...
  /// Gets a Lights property.
  [[nodiscard]] double exteriorLightingPower() const { return lights.exteriorEnergy(); }

  /// Sets a Lights property.
  void setExteriorLightingPower(double val) { lights.setExteriorEnergy(val); }

  /// Gets a Lights property.
  [[nodiscard]] double lightingPowerFixedOccupied() const { return lights.lightingPowerFixedOccupied(); }
  ...
  /// Gets a Lights property.
  [[nodiscard]] double lightingPowerFixedUnoccupied() const { return lights.lightingPowerFixedUnoccupied(); }
  ...
  /// Gets a Lights property.
  [[nodiscard]] double lightingPowerIntensityOccupied() const { return lights.powerDensityOccupied(); }

  /// Sets a Lights property.
  void setLightingPowerIntensityOccupied(double val) { lights.setPowerDensityOccupied(val); }

  /// Gets a Lights property.
  [[nodiscard]] double lightingPowerIntensityUnoccupied() const { return lights.powerDensityUnoccupied(); }

  /// Sets a Lights property.
  void setLightingPowerIntensityUnoccupied(double val) { lights.setPowerDensityUnoccupied(val); }

  /// Gets a Lights property.
  [[nodiscard]] double manualSwitchAd() const { return lights.manualSwitchAd(); }

  /// Sets a Lights property.
  void setManualSwitchAd(double manualSwitchAd) { lights.setManualSwitchAd(manualSwitchAd); }

  /// Gets a Lights property.
  [[nodiscard]] double manualSwitchLux() const { return lights.manualSwitchLux(); }

  /// Sets a Lights property.
  void setManualSwitchLux(double manualSwitchLux) { lights.setManualSwitchLux(manualSwitchLux); }

  /// Gets a Lights property.
  [[nodiscard]] double n_day_end() const { return lights.n_day_end(); }

  /// Sets a Lights property.
  void setN_day_end(double n_day_end) { lights.setN_day_end(n_day_end); }

  /// Gets a Lights property.
  [[nodiscard]] double n_day_start() const { return lights.n_day_start(); }

  /// Sets a Lights property.
  void setN_day_start(double n_day_start) { lights.setN_day_start(n_day_start); }

  /// Gets a Lights property.
  [[nodiscard]] double n_weeks() const { return lights.n_weeks(); }

  /// Sets a Lights property.
  void setN_weeks(double n_weeks) { lights.setN_weeks(n_weeks); }

  /// Gets a Lights property.
  [[nodiscard]] double naturallyLightedArea() const { return lights.naturallyLightedArea(); }
  ...
  /// Gets a Lights property.
  [[nodiscard]] double permLightPowerDensity() const { return lights.permLightPowerDensity(); }
  ...
  /// Gets a Lights property.
  [[nodiscard]] double presenceAutoAd() const { return lights.presenceAutoAd(); }

  /// Sets a Lights property.
  void setPresenceAutoAd(double presenceAutoAd) { lights.setPresenceAutoAd(presenceAutoAd); }

  /// Gets a Lights property.
  [[nodiscard]] double presenceAutoLux() const { return lights.presenceAutoLux(); }

  /// Sets a Lights property.
  void setPresenceAutoLux(double presenceAutoLux) { lights.setPresenceAutoLux(presenceAutoLux); }

  /// Gets a Lights property.
  [[nodiscard]] double presenceSensorAd() const { return lights.presenceSensorAd(); }
  ...
  /// Gets a Lights property.
  [[nodiscard]] double presenceSensorLux() const { return lights.presenceSensorLux(); }
  ...
  [[nodiscard]] double terrainClass() const { return location.terrain(); }
  ...
  [[nodiscard]] double equivFullLoadOccupancyFrom() const { return pop.hoursStart(); }

  /// Sets a Population property.
  void setEquivFullLoadOccupancyFrom(double val) { pop.setHoursStart(val); }

  /// Gets a Population property.
  [[nodiscard]] double equivFullLoadOccupancyTo() const { return pop.hoursEnd(); }
  ...
  /// Gets a Population property.
  [[nodiscard]] double peopleDensityOccupied() const { return pop.densityOccupied(); }

  /// Sets a Population property.
  void setPeopleDensityOccupied(double val) { pop.setDensityOccupied(val); }

  /// Gets a Population property.
  [[nodiscard]] double peopleDensityUnoccupied() const { return pop.densityUnoccupied(); }
  ...
  [[nodiscard]] double hci() const { return simSettings.hci(); }

  /// Sets a SimulationSettings property.
  void setHci(double hci) { simSettings.setHci(hci); }

  /// Gets a SimulationSettings property.
  [[nodiscard]] double hri() const { return simSettings.hri(); }

  /// Sets a SimulationSettings property.
  void setHri(double hri) { simSettings.setHri(hri); }

  /// Gets a SimulationSettings property.
  [[nodiscard]] double phiIntFractionToAirNode() const { return simSettings.phiIntFractionToAirNode(); }
  ...
  /// Gets a SimulationSettings property.
  [[nodiscard]] double phiSolFractionToAirNode() const { return simSettings.phiSolFractionToAirNode(); }
  ...
  /// Gets a Structure property.
  [[nodiscard]] double floorArea() const { return structure.floorArea(); }

  /// Sets a Structure property.
  void setFloorArea(double val) { structure.setFloorArea(val); }

  /// Gets a Structure property.
  [[nodiscard]] double interiorHeatCapacity() const { return structure.interiorHeatCapacity(); }

  /// Sets a Structure property.
  void setInteriorHeatCapacity(double val) { structure.setInteriorHeatCapacity(val); }

  /// Gets a Structure property.
  [[nodiscard]] double irradianceForMaxShadingUse() const { return structure.irradianceForMaxShadingUse(); }
  ...
  /// Gets a Structure property.
  [[nodiscard]] double R_sc_ext() const { return structure.R_sc_ext(); }

  /// Sets a Structure property.
  void setR_sc_ext(double R_sc_ext) { structure.setR_sc_ext(R_sc_ext); }

  /// Gets a Structure property.
  [[nodiscard]] double R_se() const { return structure.R_se(); }
  ...
  /// Gets a Structure property.
  [[nodiscard]] double roofSolarAbsorption() const { return structure.wallSolarAbsorption()[8]; }

  /// Sets a Structure property.
  void setRoofSolarAbsorption(double val) { structure.setWallSolarAbsorption(8, val); }

  /// Gets a Structure property.
  [[nodiscard]] double roofThermalEmissivity() const { return structure.wallThermalEmissivity()[8]; }

  /// Sets a Structure property.
  void setRoofThermalEmissivity(double val) { structure.setWallThermalEmissivity(8, val); }

  /// Gets a Structure property.
  [[nodiscard]] double roofUValue() const { return structure.wallUniform()[8]; }

  /// Sets a Structure property.
  void setRoofUValue(double val) { structure.setWallUniform(8, val); }

  /// Gets a Structure property.
  [[nodiscard]] double shadingFactorAtMaxUse() const { return structure.shadingFactorAtMaxUse(); }
  ...
  /// Gets a Structure property.
  [[nodiscard]] double skylightSDF() const { return structure.windowShadingDevice()[8]; }
  ...
  /// Gets a Structure property.
  [[nodiscard]] double totalAreaPerFloorArea() const { return structure.totalAreaPerFloorArea(); }
  ...
  /// Gets a Structure property.
  [[nodiscard]] double wallSolarAbsorptionE() const { return structure.wallSolarAbsorption()[2]; }

  /// Sets a Structure property.
  void setWallSolarAbsorptionE(double val) { structure.setWallSolarAbsorption(2, val); }

  /// Gets a Structure property.
  [[nodiscard]] double wallSolarAbsorptionN() const { return structure.wallSolarAbsorption()[4]; }

  /// Sets a Structure property.
  void setWallSolarAbsorptionN(double val) { structure.setWallSolarAbsorption(4, val); }

  /// Gets a Structure property.
  [[nodiscard]] double wallSolarAbsorptionNE() const { return structure.wallSolarAbsorption()[3]; }

  /// Sets a Structure property.
  void setWallSolarAbsorptionNE(double val) { structure.setWallSolarAbsorption(3, val); }

  /// Gets a Structure property.
  [[nodiscard]] double wallSolarAbsorptionNW() const { return structure.wallSolarAbsorption()[5]; }

  /// Sets a Structure property.
  void setWallSolarAbsorptionNW(double val) { structure.setWallSolarAbsorption(5, val); }

  /// Gets a Structure property.
  [[nodiscard]] double wallSolarAbsorptionS() const { return structure.wallSolarAbsorption()[0]; }

  /// Sets a Structure property.
  void setWallSolarAbsorptionS(double val) { structure.setWallSolarAbsorption(0, val); }

  /// Gets a Structure property.
  [[nodiscard]] double wallSolarAbsorptionSE() const { return structure.wallSolarAbsorption()[1]; }

  /// Sets a Structure property.
  void setWallSolarAbsorptionSE(double val) { structure.setWallSolarAbsorption(1, val); }

  /// Gets a Structure property.
  [[nodiscard]] double wallSolarAbsorptionSW() const { return structure.wallSolarAbsorption()[7]; }

  /// Sets a Structure property.
  void setWallSolarAbsorptionSW(double val) { structure.setWallSolarAbsorption(7, val); }

  /// Gets a Structure property.
  [[nodiscard]] double wallSolarAbsorptionW() const { return structure.wallSolarAbsorption()[6]; }
  ...
  /// Gets a Structure property.
  [[nodiscard]] double wallThermalEmissivityE() const { return structure.wallThermalEmissivity()[2]; }

  /// Sets a Structure property.
  void setWallThermalEmissivityE(double val) { structure.setWallThermalEmissivity(2, val); }

  /// Gets a Structure property.
  [[nodiscard]] double wallThermalEmissivityN() const { return structure.wallThermalEmissivity()[4]; }

  /// Sets a Structure property.
  void setWallThermalEmissivityN(double val) { structure.setWallThermalEmissivity(4, val); }

  /// Gets a Structure property.
  [[nodiscard]] double wallThermalEmissivityNE() const { return structure.wallThermalEmissivity()[3]; }

  /// Sets a Structure property.
  void setWallThermalEmissivityNE(double val) { structure.setWallThermalEmissivity(3, val); }

  /// Gets a Structure property.
  [[nodiscard]] double wallThermalEmissivityNW() const { return structure.wallThermalEmissivity()[5]; }

  /// Sets a Structure property.
  void setWallThermalEmissivityNW(double val) { structure.setWallThermalEmissivity(5, val); }

  /// Gets a Structure property.
  [[nodiscard]] double wallThermalEmissivityS() const { return structure.wallThermalEmissivity()[0]; }

  /// Sets a Structure property.
  void setWallThermalEmissivityS(double val) { structure.setWallThermalEmissivity(0, val); }

  /// Gets a Structure property.
  [[nodiscard]] double wallThermalEmissivitySE() const { return structure.wallThermalEmissivity()[1]; }

  /// Sets a Structure property.
  void setWallThermalEmissivitySE(double val) { structure.setWallThermalEmissivity(1, val); }

  /// Gets a Structure property.
  [[nodiscard]] double wallThermalEmissivitySW() const { return structure.wallThermalEmissivity()[7]; }

  /// Sets a Structure property.
  void setWallThermalEmissivitySW(double val) { structure.setWallThermalEmissivity(7, val); }

  /// Gets a Structure property.
  [[nodiscard]] double wallThermalEmissivityW() const { return structure.wallThermalEmissivity()[6]; }
  ...
  /// Gets a Structure property.
  [[nodiscard]] double wallUvalueE() const { return structure.wallUniform()[2]; }

  /// Sets a Structure property.
  void setWallUvalueE(double val) { structure.setWallUniform(2, val); }

  /// Gets a Structure property.
  [[nodiscard]] double wallUvalueN() const { return structure.wallUniform()[4]; }

  /// Sets a Structure property.
  void setWallUvalueN(double val) { structure.setWallUniform(4, val); }

  /// Gets a Structure property.
  [[nodiscard]] double wallUvalueNE() const { return structure.wallUniform()[3]; }

  /// Sets a Structure property.
  void setWallUvalueNE(double val) { structure.setWallUniform(3, val); }

  /// Gets a Structure property.
  [[nodiscard]] double wallUvalueNW() const { return structure.wallUniform()[5]; }

  /// Sets a Structure property.
  void setWallUvalueNW(double val) { structure.setWallUniform(5, val); }

  /// Gets a Structure property.
  [[nodiscard]] double wallUvalueS() const { return structure.wallUniform()[0]; }

  /// Sets a Structure property.
  void setWallUvalueS(double val) { structure.setWallUniform(0, val); }

  /// Gets a Structure property.
  [[nodiscard]] double wallUvalueSE() const { return structure.wallUniform()[1]; }

  /// Sets a Structure property.
  void setWallUvalueSE(double val) { structure.setWallUniform(1, val); }

  /// Gets a Structure property.
  [[nodiscard]] double wallUvalueSW() const { return structure.wallUniform()[7]; }

  /// Sets a Structure property.
  void setWallUvalueSW(double val) { structure.setWallUniform(7, val); }

  /// Gets a Structure property.
  [[nodiscard]] double wallUvalueW() const { return structure.wallUniform()[6]; }

  /// Sets a Structure property.
  void setWallUvalueW(double val) { structure.setWallUniform(6, val); }

  /// Gets a Structure property.
  [[nodiscard]] double win_F_W() const { return structure.win_F_W(); }

  /// Sets a Structure property.
  void setWin_F_W(double win_F_W) { structure.setWin_F_W(win_F_W); }

  /// Gets a Structure property.
  [[nodiscard]] double win_ff() const { return structure.win_ff(); }
  ...
  /// Gets a Structure property.
  [[nodiscard]] double windowSCFE() const { return structure.windowShadingCorrectionFactor()[2]; }

  /// Sets a Structure property.
  void setWindowSCFE(double val) { structure.setWindowShadingCorrectionFactor(2, val); }

  /// Gets a Structure property.
  [[nodiscard]] double windowSCFN() const { return structure.windowShadingCorrectionFactor()[4]; }

  /// Sets a Structure property.
  void setWindowSCFN(double val) { structure.setWindowShadingCorrectionFactor(4, val); }

  /// Gets a Structure property.
  [[nodiscard]] double windowSCFNE() const { return structure.windowShadingCorrectionFactor()[3]; }

  /// Sets a Structure property.
  void setWindowSCFNE(double val) { structure.setWindowShadingCorrectionFactor(3, val); }

  /// Gets a Structure property.
  [[nodiscard]] double windowSCFNW() const { return structure.windowShadingCorrectionFactor()[5]; }

  /// Sets a Structure property.
  void setWindowSCFNW(double val) { structure.setWindowShadingCorrectionFactor(5, val); }

  /// Gets a Structure property.
  [[nodiscard]] double windowSCFS() const { return structure.windowShadingCorrectionFactor()[0]; }

  /// Sets a Structure property.
  void setWindowSCFS(double val) { structure.setWindowShadingCorrectionFactor(0, val); }

  /// Gets a Structure property.
  [[nodiscard]] double windowSCFSE() const { return structure.windowShadingCorrectionFactor()[1]; }

  /// Sets a Structure property.
  void setWindowSCFSE(double val) { structure.setWindowShadingCorrectionFactor(1, val); }

  /// Gets a Structure property.
  [[nodiscard]] double windowSCFSW() const { return structure.windowShadingCorrectionFactor()[7]; }

  /// Sets a Structure property.
  void setWindowSCFSW(double val) { structure.setWindowShadingCorrectionFactor(7, val); }

  /// Gets a Structure property.
  [[nodiscard]] double windowSCFW() const { return structure.windowShadingCorrectionFactor()[6]; }
  ...
  /// Gets a Structure property.
  [[nodiscard]] double windowSDFE() const { return structure.windowShadingDevice()[2]; }

  /// Sets a Structure property.
  void setWindowSDFE(double val) { structure.setWindowShadingDevice(2, val); }

  /// Gets a Structure property.
  [[nodiscard]] double windowSDFN() const { return structure.windowShadingDevice()[4]; }

  /// Sets a Structure property.
  void setWindowSDFN(double val) { structure.setWindowShadingDevice(4, val); }

  /// Gets a Structure property.
  [[nodiscard]] double windowSDFNE() const { return structure.windowShadingDevice()[3]; }

  /// Sets a Structure property.
  void setWindowSDFNE(double val) { structure.setWindowShadingDevice(3, val); }

  /// Gets a Structure property.
  [[nodiscard]] double windowSDFNW() const { return structure.windowShadingDevice()[5]; }

  /// Sets a Structure property.
  void setWindowSDFNW(double val) { structure.setWindowShadingDevice(5, val); }

  /// Gets a Structure property.
  [[nodiscard]] double windowSDFS() const { return structure.windowShadingDevice()[0]; }

  /// Sets a Structure property.
  void setWindowSDFS(double val) { structure.setWindowShadingDevice(0, val); }

  /// Gets a Structure property.
  [[nodiscard]] double windowSDFSE() const { return structure.windowShadingDevice()[1]; }

  /// Sets a Structure property.
  void setWindowSDFSE(double val) { structure.setWindowShadingDevice(1, val); }

  /// Gets a Structure property.
  [[nodiscard]] double windowSDFSW() const { return structure.windowShadingDevice()[7]; }

  /// Sets a Structure property.
  void setWindowSDFSW(double val) { structure.setWindowShadingDevice(7, val); }

  /// Gets a Structure property.
  [[nodiscard]] double windowSDFW() const { return structure.windowShadingDevice()[6]; }
  ...
  /// Gets a Structure property.
  [[nodiscard]] double windowSHGCE() const {
  ...
  /// Gets a Structure property.
  [[nodiscard]] double windowSHGCN() const {
  ...
  /// Gets a Structure property.
  [[nodiscard]] double windowSHGCNE() const {
  ...
  /// Gets a Structure property.
  [[nodiscard]] double windowSHGCNW() const {
  ...
  /// Gets a Structure property.
  [[nodiscard]] double windowSHGCS() const {
  ...
  /// Gets a Structure property.
  [[nodiscard]] double windowSHGCSE() const {
  ...
  /// Gets a Structure property.
  [[nodiscard]] double windowSHGCSW() const {
  ...
  /// Gets a Structure property.
  [[nodiscard]] double windowSHGCW() const {
  ...
  /// Gets a Structure property.
  [[nodiscard]] double windowUvalueE() const { return structure.windowUniform()[2]; }

  /// Sets a Structure property.
  void setWindowUvalueE(double val) { structure.setWindowUniform(2, val); }

  /// Gets a Structure property.
  [[nodiscard]] double windowUvalueN() const { return structure.windowUniform()[4]; }

  /// Sets a Structure property.
  void setWindowUvalueN(double val) { structure.setWindowUniform(4, val); }

  /// Gets a Structure property.
  [[nodiscard]] double windowUvalueNE() const { return structure.windowUniform()[3]; }

  /// Sets a Structure property.
  void setWindowUvalueNE(double val) { structure.setWindowUniform(3, val); }

  /// Gets a Structure property.
  [[nodiscard]] double windowUvalueNW() const { return structure.windowUniform()[5]; }

  /// Sets a Structure property.
  void setWindowUvalueNW(double val) { structure.setWindowUniform(5, val); }

  /// Gets a Structure property.
  [[nodiscard]] double windowUvalueS() const { return structure.windowUniform()[0]; }

  /// Sets a Structure property.
  void setWindowUvalueS(double val) { structure.setWindowUniform(0, val); }

  /// Gets a Structure property.
  [[nodiscard]] double windowUvalueSE() const { return structure.windowUniform()[1]; }

  /// Sets a Structure property.
  void setWindowUvalueSE(double val) { structure.setWindowUniform(1, val); }

  /// Gets a Structure property.
  [[nodiscard]] double windowUvalueSW() const { return structure.windowUniform()[7]; }

  /// Sets a Structure property.
  void setWindowUvalueSW(double val) { structure.setWindowUniform(7, val); }

  /// Gets a Structure property.
  [[nodiscard]] double windowUvalueW() const { return structure.windowUniform()[6]; }

  /// Sets a Structure property.
  void setWindowUvalueW(double val) { structure.setWindowUniform(6, val); }

  /// Gets a Ventilation property.
  [[nodiscard]] double dCp() const { return ventilation.dCp(); }

  /// Sets a Ventilation property.
  void setDCp(double dCp) { ventilation.setDCp(dCp); }

  /// Gets a Ventilation property.
  [[nodiscard]] double exhaustAirRecirclation() const { return ventilation.exhaustAirRecirculated(); }

  /// Sets a Ventilation property.
  void setExhaustAirRecirclation(double val) { ventilation.setExhaustAirRecirculated(val); }

  /// Gets a Ventilation property.
  [[nodiscard]] double fanFlowControlFactor() const { return ventilation.fanControlFactor(); }

  /// Sets a Ventilation property.
  void setFanFlowControlFactor(double val) { ventilation.setFanControlFactor(val); }

  /// Gets a Ventilation property.
  [[nodiscard]] double freshAirFlowRate() const { return ventilation.supplyRate(); }

  /// Sets a Ventilation property.
  void setFreshAirFlowRate(double val) { ventilation.setSupplyRate(val); }

  /// Gets a Ventilation property.
  [[nodiscard]] double H_ve() const { return ventilation.H_ve(); }

  /// Sets a Ventilation property.
  void setH_ve(double H_ve) { ventilation.setH_ve(H_ve); }

  /// Gets a Ventilation property.
  [[nodiscard]] double heatRecovery() const { return ventilation.heatRecoveryEfficiency(); }

  /// Sets a Ventilation property.
  void setHeatRecovery(double val) { ventilation.setHeatRecoveryEfficiency(val); }

  /// Gets a Ventilation property.
  [[nodiscard]] double hzone() const { return ventilation.hzone(); }

  /// Sets a Ventilation property.
  void setHzone(double hzone) { ventilation.setHzone(hzone); }

  /// Gets a Ventilation property.
  [[nodiscard]] double infiltrationRateUnoccupied() const { return ventilation.infiltrationRateUnoccupied(); }
  ...
  /// Gets a Ventilation property.
  [[nodiscard]] double n50() const { return ventilation.n50(); }

  /// Sets a Ventilation property.
  void setN50(double n50) { ventilation.setN50(n50); }

  /// Gets a Ventilation property.
  [[nodiscard]] double p_exp() const { return ventilation.p_exp(); }

  /// Sets a Ventilation property.
  void setP_exp(double p_exp) { ventilation.setP_exp(p_exp); }

  /// Gets a Ventilation property.
  [[nodiscard]] double specificFanPower() const { return ventilation.fanPower(); }

  /// Sets a Ventilation property.
  void setSpecificFanPower(double val) { ventilation.setFanPower(val); }

  /// Gets a Ventilation property.
  [[nodiscard]] double stack_coeff() const { return ventilation.stack_coeff(); }

  /// Sets a Ventilation property.
  void setStack_coeff(double stack_coeff) { ventilation.setStack_coeff(stack_coeff); }

  /// Gets a Ventilation property.
  [[nodiscard]] double stack_exp() const { return ventilation.stack_exp(); }

  /// Sets a Ventilation property.
  void setStack_exp(double stack_exp) { ventilation.setStack_exp(stack_exp); }

  /// Gets a Ventilation property.
  [[nodiscard]] double supplyExhaustRate() const { return ventilation.supplyDifference(); }

  /// Sets a Ventilation property.
  void setSupplyExhaustRate(double val) { ventilation.setSupplyDifference(val); }

  /// Gets a Ventilation property.
  [[nodiscard]] double vent_rate_flag() const { return ventilation.vent_rate_flag(); }

  /// Sets a Ventilation property.
  void setVent_rate_flag(int vent_rate_flag) { ventilation.setVent_rate_flag(vent_rate_flag); }

  /// Gets a Ventilation property.
  [[nodiscard]] double ventilationExhaustRateUnoccupied() const {
  ...
  /// Gets a Ventilation property.
  [[nodiscard]] double ventilationIntakeRateUnoccupied() const {
  ...
  /// Gets a Ventilation property.
  [[nodiscard]] double ventilationType() const { return static_cast<double>(ventilation.ventType()); }
  ...
  /// Gets a Ventilation property.
  [[nodiscard]] double ventPreheatDegC() const { return ventilation.ventPreheatDegC(); }
  ...
  /// Gets a Ventilation property.
  [[nodiscard]] double wind_coeff() const { return ventilation.wind_coeff(); }

  /// Sets a Ventilation property.
  void setWind_coeff(double wind_coeff) { ventilation.setWind_coeff(wind_coeff); }

  /// Gets a Ventilation property.
  [[nodiscard]] double wind_exp() const { return ventilation.wind_exp(); }

  /// Sets a Ventilation property.
  void setWind_exp(double wind_exp) { ventilation.setWind_exp(wind_exp); }

  /// Gets a Ventilation property.
  [[nodiscard]] double zone_frac() const { return ventilation.zone_frac(); }
