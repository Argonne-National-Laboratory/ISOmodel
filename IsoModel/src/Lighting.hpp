...
public:
  ...
  [[nodiscard]] double powerDensityOccupied() const { return m_powerDensityOccupied; }
  void setPowerDensityOccupied(double value) { m_powerDensityOccupied = value; }

  [[nodiscard]] double powerDensityUnoccupied() const { return m_powerDensityUnoccupied; }
  void setPowerDensityUnoccupied(double value) { m_powerDensityUnoccupied = value; }

  [[nodiscard]] double dimmingFraction() const { return m_dimmingFraction; }
  void setDimmingFraction(double value) { m_dimmingFraction = value; }

  [[nodiscard]] double exteriorEnergy() const { return m_exteriorEnergy; }
  void setExteriorEnergy(double value) { m_exteriorEnergy = value; }

  [[nodiscard]] double n_day_start() const { return m_n_day_start; }
  void setN_day_start(double value) { m_n_day_start = value; }

  [[nodiscard]] double n_day_end() const { return m_n_day_end; }
  void setN_day_end(double value) { m_n_day_end = value; }

  [[nodiscard]] double n_weeks() const { return m_n_weeks; }
  void setN_weeks(double value) { m_n_weeks = value; }

  [[nodiscard]] double elecInternalGains() const { return m_elecInternalGains; }
  void setElecInternalGains(double value) { m_elecInternalGains = value; }

  [[nodiscard]] double permLightPowerDensity() const { return m_permLightPowerDensity; }
  void setPermLightPowerDensity(double value) { m_permLightPowerDensity = value; }

  [[nodiscard]] double presenceSensorAd() const { return m_presenceSensorAd; }
  void setPresenceSensorAd(double value) { m_presenceSensorAd = value; }

  [[nodiscard]] double automaticAd() const { return m_automaticAd; }
  void setAutomaticAd(double value) { m_automaticAd = value; }

  [[nodiscard]] double presenceAutoAd() const { return m_presenceAutoAd; }
  void setPresenceAutoAd(double value) { m_presenceAutoAd = value; }

  [[nodiscard]] double manualSwitchAd() const { return m_manualSwitchAd; }
  void setManualSwitchAd(double value) { m_manualSwitchAd = value; }

  [[nodiscard]] double presenceSensorLux() const { return m_presenceSensorLux; }
  void setPresenceSensorLux(double value) { m_presenceSensorLux = value; }

  [[nodiscard]] double automaticLux() const { return m_automaticLux; }
  void setAutomaticLux(double value) { m_automaticLux = value; }

  [[nodiscard]] double presenceAutoLux() const { return m_presenceAutoLux; }
  void setPresenceAutoLux(double value) { m_presenceAutoLux = value; }

  [[nodiscard]] double manualSwitchLux() const { return m_manualSwitchLux; }
  void setManualSwitchLux(double value) { m_manualSwitchLux = value; }

  [[nodiscard]] double naturallyLightedArea() const { return m_naturallyLightedArea; }
  void setNaturallyLightedArea(double value) { m_naturallyLightedArea = value; }

  [[nodiscard]] double lightingPowerFixedOccupied() const { return m_lightingPowerFixedOccupied; }
  void setLightingPowerFixedOccupied(double value) { m_lightingPowerFixedOccupied = value; }

  [[nodiscard]] double lightingPowerFixedUnoccupied() const { return m_lightingPowerFixedUnoccupied; }
