...
//
// Summary:
// Defines the `Population` class, a data container for building occupancy
// parameters. This includes daily and weekly occupancy schedules (start/end
// times), people density, and the metabolic heat gain per person.
...
public:
   ...
   */
  double hoursStart() const { return m_hoursStart; }
   ...
   * hoursStart() == 9 and hoursEnd() == 16.
   */
  double hoursEnd() const { return m_hoursEnd; }
   ...
   */
  double daysStart() const { return m_daysStart; }
