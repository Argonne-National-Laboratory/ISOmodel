...
public:
   ...
   */
  [[nodiscard]] double hoursStart() const { return m_hoursStart; }
   ...
   * hoursStart() == 9 and hoursEnd() == 16.
   */
  [[nodiscard]] double hoursEnd() const { return m_hoursEnd; }
   ...
   */
  [[nodiscard]] double daysStart() const { return m_daysStart; }
