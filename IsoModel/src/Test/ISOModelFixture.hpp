...
//
// Summary:
// This file defines the `ISOModelFixture` class, a test fixture for the
// Google Test framework. It provides common setup (`SetUp`) and teardown
// (`TearDown`) logic for the ISOModel tests, such as initializing end-use
// name vectors and managing test data paths. This helps reduce boilerplate
// code in individual test files.
