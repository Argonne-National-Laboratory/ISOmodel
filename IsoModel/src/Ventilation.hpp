...
public:
   ...
   */
  [[nodiscard]] double supplyRate() const { return m_supplyRate; }
  void setSupplyRate(double value) { m_supplyRate = value; }

  /**
   * Ventilation exhaust rate occupied (L/s).
   */
  [[nodiscard]] double supplyDifference() const { return m_supplyDifference; }
   ...
   */
  [[nodiscard]] double heatRecoveryEfficiency() const { return m_heatRecoveryEfficiency; }
  void setHeatRecoveryEfficiency(double value) { m_heatRecoveryEfficiency = value; }

  /**
   * Fraction of supply air recirculated (unitless).
   */
  [[nodiscard]] double exhaustAirRecirculated() const { return m_exhaustAirRecirculated; }
   ...
   */
  [[nodiscard]] double dCp() const { return m_dCp; }
   ...
   * unoccupied times.
   */
  [[nodiscard]] int vent_rate_flag() const { return m_vent_rate_flag; }
   ...
   */
  [[nodiscard]] double H_ve() const { return m_H_ve; }
  void setH_ve(double H_ve) { m_H_ve = H_ve; }

  [[nodiscard]] double infiltrationRateUnoccupied() const { return m_infiltrationRateUnoccupied; }
  ...
  [[nodiscard]] double ventilationExhaustRateUnoccupied() const { return m_ventilationExhaustRateUnoccupied; }
  ...
  [[nodiscard]] double ventilationIntakeRateUnoccupied() const { return m_ventilationIntakeRateUnoccupied; }
